        ...
        if (M_dataset->coupled)
        {
            ...
            //  MU_full=M_dataset->grid.dimension_y_count_netcdf*M_dataset->grid.dimension_x_count_netcdf           
                ...
                if (M_comm.rank() == 0) {                    
                    ...
                    synforc_p = perturbation.synopticPerturbation(M_full,N_full,M_dataset->synforc, M_dataset->randfld,M_dataset->perturbation_count); //synforc and randfld
                ...
                for(int ii=0; ii<2; ii++) {       // loop u,v         
                    // boost::mpi::broadcast(M_comm,  &M_dataset->synforc[i][0], MN_full, 0);                
                ...
                perturbation.addPerturbation(M_dataset->variables[0].loaded_data[1], M_dataset->variables[1].loaded_data[1], M_dataset->synforc[0],M_dataset->synforc[1], x_start, y_start, x_count, y_count); 
