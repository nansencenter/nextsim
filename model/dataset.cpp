...
DataSet::DataSet(char const *DatasetName)
{
    ...
    else
    {
        ...
        fprintf (stderr, "topaz_forecast_nodes\n");
        fprintf (stderr, "topaz_forecast_elements\n");
...
void DataSet::initErai(const std::string option)
{
    ...
    else if(option=="elements")
    {
        ...
        variables[4] = tcc;
        variables[5] = precip;
        variables[6] = snowfall;

        vectorial_variables.resize(0);
    }
    else
        throw std::runtime_error("initErai - bad option ("+option+")\n");
...
void DataSet::initEc(const std::string option)
{
    ...
    else if(option=="elements")
    {
        ...
        throw std::runtime_error("initEc - bad option ("+option+")\n");
...
void DataSet::initEc2(const std::string option)
{
    // Definition of dimensions
    Dimension dimension_x={
        name:"lon",
    ...
    else if(option=="elements")
    {
        ...
        throw std::runtime_error("initEc2 - bad option ("+option+")\n");
...
// ================================================
// ocean forcing
void DataSet::initOceanCurrents()
{
...
void DataSet::initTopaz(const std::string option)
{
    ...
    else if(option == "elements")
    {
        ...
        variables[1] = sss;
        variables[2] = mld;
        mask_index   = 1;//mask with sss

        vectorial_variables.resize(0);
    }
    else
        throw std::runtime_error("initTopaz - bad option ("+option+")\n");
    ...
    grid = {
        ...
        masking: true,
        masking_variable: variables[mask_index]
    };
...
void DataSet::initTopazForecast(const std::string option)
{
    ...
    std::string target_loc = "mesh_nodes";
    int mask_index = 0;//use u for masking
    ...
    if(option=="nodes")
    {
        ...
        Vectorial_Variable uv={
            components_Id: uv_tmp,
            east_west_oriented: false
                // if false, then we assume it is oriented following the mpp_file defined for the grid
        };
    ...
    else if(option=="nodes")
    {
        ...
        variables[3] = conc;
        variables[4] = thick;
        variables[5] = snow_thick;

        mask_index  = 1;//use sss for masking
        vectorial_variables.resize(0);
    }
    else
        throw std::runtime_error("initTopaz - bad option ("+option+")\n");
