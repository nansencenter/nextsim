    ...
    M_comm(Environment::comm())
{
    ...
    else if (strcmp (DatasetName, "wrf_ps_atm_nodes") == 0)
    {
        // Definition of asr grid and datasets
        Dimension dimension_x={
            name:"west_east",
        ...
        Grid grid_tmp={
            ...
            dirname: Environment::vm()["setup.atmospheric_forcing_input_path"].as<std::string>(),
            filename_mask: "wrfout_%Y-%m-%d.nc",
            gridfile: "",
            reference_date: "2020-04-10",
    ...
    else if (strcmp (DatasetName, "wrf_ps_atm_elements") == 0)
    {
        // Definition of asr grid and datasets
        Dimension dimension_x={
            name:"west_east",
        ...
        //    a:physical::rhow/(1000.*3600.), // for conversion from PRECIP_ACC (mm/hour)
            a:physical::rhow/(1000.*1800.), // Now we think PRECIP_ACC is in mm, so need to divide by 30min after all
            b:0.,
            Units:"kg/m^2/s",
            loaded_data: loaded_data_tmp,
            interpolated_data: interpolated_data_tmp,
        ...
        std::vector<Variable> variables_tmp
            = { tair, sphuma, mslp, Qsw_in, Qlw_in, snowfr, precip };
    ...
    // wrf one timeslice - wrfrst naming
    else if (strcmp (DatasetName, "wrfrst_ps_atm_nodes") == 0) 
    {
        // Definition of asr grid and datasets
        Dimension dimension_x={
            name:"west_east",
        ...
        Grid grid_tmp={
            ...
            dirname: Environment::vm()["setup.atmospheric_forcing_input_path"].as<std::string>(),
            filename_mask: "wrfrst_%Y-%m-%d.nc",
            gridfile: "",
            reference_date: "2020-04-10",
    ...
    else if (strcmp (DatasetName, "wrfrst_ps_atm_elements") == 0)
    {
        // Definition of asr grid and datasets
        Dimension dimension_x={
            name:"west_east",
    ...
    // wrf one timeslice - wrfrst
    else if (strcmp (DatasetName, "wrfrstext_ps_atm_nodes") == 0) 
    {
        // Definition of asr grid and datasets
        Dimension dimension_x={
            name:"west_east",
        ...
        Grid grid_tmp={
            ...
            dirname: Environment::vm()["setup.atmospheric_forcing_input_path"].as<std::string>(),
            filename_mask: "wrfrst_%Y-%m-%d_%H-%M-%S.nc",
            gridfile: "",
            reference_date: "2020-04-10",
    ...
    else if (strcmp (DatasetName, "wrfrstext_ps_atm_elements") == 0)
    {
        // Definition of asr grid and datasets
        Dimension dimension_x={
            name:"west_east",
