...
FiniteElement::initDatasets()
{
    ...
    switch(M_atmosphere_type){
        ...
        case setup::AtmosphereType::WRFRST_PS:
            M_atmosphere_nodes_dataset=DataSet("wrfrst_ps_atm_nodes");
            M_atmosphere_elements_dataset=DataSet("wrfrst_ps_atm_elements");
            break;

        case setup::AtmosphereType::WRFRSTEXT_PS:
            M_atmosphere_nodes_dataset=DataSet("wrfrstext_ps_atm_nodes");
            M_atmosphere_elements_dataset=DataSet("wrfrstext_ps_atm_elements");
            break;
...
FiniteElement::initOptAndParam()
{
    ...
    const boost::unordered_map<const std::string, setup::AtmosphereType> str2atmosphere = boost::assign::map_list_of
        ...
        ("wrfrst_ps", setup::AtmosphereType::WRFRST_PS)
        ("wrfrstext_ps", setup::AtmosphereType::WRFRSTEXT_PS)
