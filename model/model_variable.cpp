...
ModelVariable::initElemental()
{
    ...
    switch (M_varID)
    {
        ...
        case (variableID::M_analysis_conc):
            // concentration of thick ice
            M_name = "M_analysis_conc";
            M_export_name = "Concentration_thick_ice_analysis";
            M_prognostic = false;
            M_exporting = false;
            M_interp_method = interpMethod::conservative;
            M_interp_transformation = interpTransformation::none;
        ...
        case (variableID::M_analysis_thick):
            // thickness of thick ice [m]
            M_name = "M_analysis_thick";
            M_export_name = "Thick_ice_analysis";
            M_prognostic = false;
            M_exporting = false;
            M_interp_method = interpMethod::conservative;
            M_interp_transformation = interpTransformation::none;
        ...
        case (variableID::M_analysis_thick_est):
            // thickness of thick ice [m]
            M_name = "M_analysis_thick_est";
            M_export_name = "Thick_ice_analysis_est";
            M_prognostic = false;
            M_exporting = false;
            M_interp_method = interpMethod::conservative;
            M_interp_transformation = interpTransformation::none;
        ...
        case (variableID::M_analysis_snow_thick):
            // snow thickness on thick ice [m]
            M_name = "M_analysis_snow_thick";
            M_export_name = "Snow_thick_ice_analysis";
            M_prognostic = false;
            M_exporting = false;
            M_interp_method = interpMethod::conservative;
            M_interp_transformation = interpTransformation::none;
        ...
        case (variableID::M_analysis_ridge_ratio):
            // volume ratio of ridged ice
            M_name = "M_analysis_ridge_ratio";
            M_export_name = "Ridge_ratio_analysis";
            M_prognostic = false;
            M_exporting = false;
            M_interp_method = interpMethod::conservative;
            M_interp_transformation = interpTransformation::none;
