...
public:
    ...
    enum variableID
    {
        ...
        D_del_hi           = 126,
        D_del_hi_young     = 127,
        D_del_vi_newfrazil = 128,
        D_del_vi_mlt_bot   = 129,
        D_del_vi_mlt_top   = 130,
        D_del_vi_snow2ice  = 131,
        D_del_vi_bot_young = 132,
        D_divergence       = 133,
        D_albedo           = 134,
        ...
        D_pond_fraction    = 141,
        D_del_ci_thermo      = 142,
        D_del_ci_thermo_young= 143,
        D_del_vi_young2old   = 144,
        D_del_ci_young2old   = 145,
        D_del_ci_ridge       = 146,
        D_del_ci_ridge_young = 147,
        D_del_vi_ridge_young = 148,
    };
