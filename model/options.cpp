...
namespace Nextsim
{
...

    {
        ...
        desc.add_options()
            ...
            ("setup.atmosphere-resolution", po::value<std::string>()->default_value( "10" ),
             "spatial resolution of atmospheric forcing in km (for WRF filename)")
            ("setup.atmosphere-refdate", po::value<std::string>()->default_value( "" ),
             "reference date for atmospheric forcing (for WRF only). Format: yyyy-mm-dd")
