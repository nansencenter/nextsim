...
namespace Nextsim
{
...

    {
        ...
        desc.add_options()
            ...
            // - Internal stresses
            ("dynamics.C_perturb_factor", po::value<double>()->default_value( 0.0 ), "")     // Fraction of C_fix that will be added to C_fix as some alea on the cohesion as C_fix ± C_perturb_factor
