...
namespace Nextsim
{
    ...
    descrOptions()
    {
        ...
        desc.add_options()
            ...
            ("forcing.wind-type", po::value<std::string>()->default_value( "asr" ), "")
            ("forcing.ocean-type", po::value<std::string>()->default_value( "constant" ), "")
            ("forcing.thermo-type", po::value<std::string>()->default_value( "constant" ), "")
            ("forcing.concentration-type", po::value<std::string>()->default_value( "constant" ), "")
            ("forcing.thickness-type", po::value<std::string>()->default_value( "constant" ), "")
            ("forcing.snow-thickness-type", po::value<std::string>()->default_value( "constant" ), "")
            ("forcing.damage-type", po::value<std::string>()->default_value( "constant" ), "")
            ...
            ("simul.time_relaxation_damage", po::value<double>()->default_value( 14. ), "")
            ...
            ("simul.compr_strength", po::value<double>()->default_value( 100e+3 ), "")
            ...
            ("simul.newice_type", po::value<std::string>()->default_value( "Hibler" ), "")
            ("simul.PhiM", po::value<double>()->default_value( 0.5 ), "")
