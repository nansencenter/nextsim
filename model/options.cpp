...
namespace Nextsim
{
...

    {
        ...
        desc.add_options()
            ...
            ("drifters.iabp_drifters_output_time_step", po::value<double>()->default_value( .5 ), "days")
            ...
            ("drifters.equally_spaced_drifters_output_time_step", po::value<double>()->default_value( .5 ), "days")
            ...
            ("drifters.rgps_drifters_output_time_step", po::value<double>()->default_value( 0.5 ), "days")
            ...
            ("drifters.sidfex_drifters_output_time_step", po::value<double>()->default_value( 0.5 ), "days")
