...
namespace Nextsim
{
...

    {
        ...
        desc.add_options()
            ...
            ("thermo.freezingpoint-type", po::value<std::string>()->default_value( "linear" ), "How to calculate the freezing point of sea water, either linear,unesco or non-linear")
