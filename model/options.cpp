...
namespace Nextsim
{
...

    {
        ...
        desc.add_options()
            ...
            // - Internal stresses
            ("dynamics.C_perturb_factor", po::value<double>()->default_value( 0.0 ), "")     // Fraction of C_fix that will be added to C_fix as some alea on the cohesion as C_fix*(1 ± C_perturb_factor)
            ...
            ("dynamics.TIGGE_quad_drag_coef_air", po::value<double>()->default_value( 0.0020 ), "")
            ...
            ("statevector.restart_path", po::value<std::string>()->default_value( "" ), "where to find restart files mem???.nc.analysis")  // todo: fix restart_input in getFilename, it is used in dataset.cpp enkf_analysis_elements
            ("statevector.DAtype", po::value<std::string>()->default_value( "sic" ), "sic|sit|sitsic")
            ...
            ("statevector.output_timestep", po::value<double>()->default_value( 1 ), "time interval between  records (days)")
            ...
            ("statevector.grid_longitude", po::value<std::string>()->default_value( "longitude" ), "The name of the longitude variable in the statevector_grid_file")
            ...
            ("statevector.prefix", po::value<std::string>()->default_value( "prior" ), "prefix for output files")
#endif
