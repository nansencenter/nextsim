...
namespace Nextsim
{
    ...
    descrOptions()
    {
        ...
        desc.add_options()
            ...
            ("simul_in.gravity", po::value<double>()->default_value( 9.80616 ), "")
            ...
            ("simul_in.use_ocean_forcing", po::value<bool>()->default_value( false ), "")
            ...
            ("simul_in.init_thickness", po::value<double>()->default_value( 1.0 ), "")
            ("simul_in.init_concentration", po::value<double>()->default_value( 1.0 ), "")
