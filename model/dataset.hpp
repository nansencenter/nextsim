...
public:
    ...
    void getXY_regular_latlon(int dimension_x_start,int dimension_y_start, int dimension_x_count, int dimension_y_count, double* LAT, double* LON,netCDF::NcVar* VLAT_ptr,netCDF::NcVar* VLON_ptr);
