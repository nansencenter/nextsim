...
//     ncw_inq_varid(ncid, "lat", &varid_lat);
//     lat = alloc2d(ylen, xlen, sizeof(float));  // refer to reader_amsre.c,  using 2d array is easier for understanding. sit[i*j+j]] in standard2 is a bug to be fixed in future
//     ncw_get_var_float(ncid, varid_lat, lat[0]);
