    ...
    descrWimOptions()
    {
        ...
        desc.add_options()
            ...
            ("nextwim.coupling-option", po::value<std::string>()->default_value( "naive" ),
                  "Coupling option: naive->interp nfloes onto mesh after exiting WIM; breaking_on_mesh->import mesh and do breaking on mesh in parallel; run_on_mesh->run WIM on neXtSIM mesh")
