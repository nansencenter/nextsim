...
// instantiate methods for Nextsim::GmshMeshSeq
template
MeshInfo<double>::MeshInfo<Nextsim::GmshMeshSeq>(Nextsim::GmshMeshSeq const &movedmesh);
template
MeshInfo<double>::MeshInfo<Nextsim::GmshMeshSeq>(Nextsim::GmshMeshSeq const &movedmesh, BamgMesh* bamgmesh, int const& flag_fix);
template void
MeshInfo<double>::setFields<Nextsim::GmshMeshSeq>(Nextsim::GmshMeshSeq const &mesh_in);
