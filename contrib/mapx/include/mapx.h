...
void close_mapx(mapx_class *current);
int reinit_mapx(mapx_class *current);
int within_mapx(mapx_class *current, double lat, double lon);
int forward_mapx(mapx_class *current,
		 double lat, double lon, double *u, double *v);
int inverse_mapx(mapx_class *current,
		 double u, double v, double *lat, double *lon);
int forward_xy_mapx(mapx_class *current,
		    double lat, double lon, double *x, double *y);
int inverse_xy_mapx(mapx_class *current,
