...
inline void checkTriangle(BamgMesh* bamgmesh, int numLocalTriangles, std::vector<double> const &gridCornerX, std::vector<double> const &gridCornerY, int current_number, // inputs
