...
VOLUMES+=("-v /home/timill/Github-Repos/nextsim-cxx/nextsim/mesh:/nextsim_mesh_dir/:ro")

# $NEXTSIM_DATA_DIR (read-only)
VOLUMES+=("-v /home/timill/Github-Repos/nextsim-cxx/nextsim/data:/nextsim_data_dir/:ro")
