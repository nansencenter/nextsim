...
date_start=datenum('15-Nov-2006 00:00:00');
%date_start=datenum('06-Feb-2007 00:00:00');
%date_start=datenum('24-Jan-2007 00:00:00');
%date_end=date_start+5;
%date_end=datenum('20-Jan-2007 00:00:00')+34;
%date_end=datenum('11-Apr-2007 00:00:00');
date_end=datenum('15-Apr-2007 00:00:00');


period_length=1;
i=0;
for date=date_start:period_length:date_end
    close all
    ...
    %plots_def_map({saved_mod_name},{['mod_' num2str(date)]},'BKF',1,'png',date+0.5*period_length);
    %plots_def_map({saved_mod_name},{['mod_' num2str(date)]},'bigkara',0,'png',date+0.5*period_length);
    plots_def_map({saved_mod_name},{['mod_' num2str(i)]},'arctic',0,'jpeg',date+0.5*period_length);
