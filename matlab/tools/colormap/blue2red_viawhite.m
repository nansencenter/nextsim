function map = blue2red_white(varargin)
...
r = zeros(256,1);
r(1:128) = linspace(100, 90, 128);
r(129:256)=linspace(90, 0, 128);

g = zeros(256,1);
g(1:128) = linspace(0, 90, 128);
% g(1:128) = linspace(0, 100, 128);
g(129:256)=linspace(90, 0, 128);

b = zeros(256,1);
b(1:128) = linspace(0,90,128);
b(129:256) = linspace(90,100,128);
